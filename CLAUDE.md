...
### Task Management
1. **Plan First**: Use plan mode or write plan to track progress
2. **Verify Plan**: Check in before starting implementation
3. **Track Progress**: Use TodoWrite to mark items complete as you go
4. **Explain Changes**: High-level summary at each step
5. **Document Results**: Update CLAUDE.md with new patterns/learnings
6. **Capture Lessons**: Add corrections to this file after mistakes
